...
const route: Routes = (app: express.Application, models: ModelFactoryInterface): express.Router => {
    ...
    router.post('/', validation.login, a(async (req: express.Request, res: express.Response): Promise<void> => {
    ...
    router.delete('/', a(async (req: express.Request, res: express.Response): Promise<void> => {
        if (req.user) {
